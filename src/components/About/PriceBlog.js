...
const pricingBlog= [
    {price:'11', title:'Lite', title2:'Life-includes:', phase: 'Phase 1', description: 'We shall have a team at the Event to talk to different merchants who have come to register with us by telling them about the benefits.', description2: 'We shall set milestones and targets for our merchants to hit so they can qualify to apply for liquidity from us on credit.'},
    {price:'21', title:'Pro',content:<div className="tagline">POPULER</div>, title2:'Everythings in Lite, Plus', phase: 'Phase 2', description: 'We shall launch an internal referral program to boost the sign ups Refer someone, when they Sign Up & for every  transactions you earn $10', description2: 'We shall set up a physical location in each location (Uganda, Kenya and Nigeria)'},
    {price:'32', title:'Ultimate',title2:'Everythings in Lite', phase: 'Phase 3', description: 'Incentivise merchants to join', description2: 'Recruit an adequate number of merchants throughout the market to support a commercial launch.', description3: 'Outsource a team/company on ground to onboard merchants'},
];
                    ...
                    >
                        <div className="pricingtable-inner">
                            ...
                            <div className="pricingtable-price">
                                ...
                                <div className="days-label bg-primary">{data.phase}</div>
                                {/* <h6>{data.title2}</h6> */}
                            </div>
                            {/* <PriceList /> */}
                            <ul className="pricingtable-features">
                        ...
                        <div className="pricingtable-footer">
                            <a href='https://www.bundle.africa/?shortlink=ogsfz9e9&c=Typeform%20Merchant%20Applicants&pid=typeform&deep_link_value=typeform_merchant_applications&af_xp=email&source_caller=ui' className="btn">Bundle Download Link</a>
                        </div>
                    </div>
                </div>
            ))}
