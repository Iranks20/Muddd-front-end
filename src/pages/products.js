...
function BlogGrid(){
    ...
    const cardStyle = {
        height: '500px', // Set a fixed height for the card description container
        overflow: 'hidden'
      };
            ...
            <div className="page-content">
                ...
                <section className="bg-light content-inner">
                    ...
                    {gridData.map((item, ind) => (
                        ...
                        <div className="dz-card style-1 blog-lg overlay-shine" style={cardStyle}>
                            <div className="dz-media">
                            <img src={item.image1} alt="" />
                            </div>
                            <div className="dz-info">
                            <h4 className="dz-title">{item.title}</h4>
                            <p className="dz-description" style={descriptionStyle}>{item.description}</p>
                            <a className="btn btn-primary" onClick={() => navigateToNextPage(item)}>Read More</a>
                            </div>
                        </div>
                        </div>
                    ))}
